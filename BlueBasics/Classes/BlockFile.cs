...
/// Hat sich jemand innerhalb von EditTimeInMinutes Minuten eingetragen,
/// gilt die zugehörige Datei als gesperrt für andere.
/// Lesezugriffe erfolgen über den transparenten Read-Cache von IO.
/// </summary>
public sealed class BlockFile {
    ...
    /// <summary>
    /// Zeitfenster, in dem die Sperre nachrichtlich als aktiv gemeldet wird.
    /// </summary>
    private const double EditTimeInMinutes = 10;

    /// <summary>
    /// Ab diesem Alter gilt die Sperre als abgelaufen und kann überschrieben werden.
    /// </summary>
    ...
    /// <summary>
    /// Schreibt die .blk-Sperre für die angegebene Datei mit den aktuellen Prozessdaten.
    /// </summary>
    /// <param name="myId">Prozess-spezifische ID des Aufrufers (BlockableFile.MyId).</param>
    ...
    /// <summary>
    /// Liefert eine Blocker-Meldung falls ein anderer die Datei sperrt, sonst string.Empty.
    /// </summary>
    ...
    /// <summary>
    /// Prüft, ob der aktuelle Prozess die aktive Sperre für die angegebene Datei hält.
    /// </summary>
    /// <param name="myId">Prozess-spezifische ID des Aufrufers (BlockableFile.MyId).</param>
    ...
    /// <summary>
    /// True, wenn die Sperre abgelaufen (SaveTimeInMinutes) oder nie gesetzt wurde.
    /// </summary>
    ...
    /// <summary>
    /// "daten.csv" → "daten.blk". Leer bei leerer Eingabe.
    /// </summary>
