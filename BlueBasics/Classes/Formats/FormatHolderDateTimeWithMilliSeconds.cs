...
public class FormatHolderDateTimeWithMilliSeconds : FormatHolder {

    public static readonly string Keyname = "DateTimeWithMilliSeconds";

    #region Constructors

    public FormatHolderDateTimeWithMilliSeconds() : base(Keyname, QuickImage.Get(ImageCode.Uhr, 16)) {
