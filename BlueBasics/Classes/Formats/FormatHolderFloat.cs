...
public class FormatHolderFloat : FormatHolder {

    public static readonly string Keyname = "Float";

    #region Constructors

    public FormatHolderFloat() : base(Keyname, QuickImage.Get(ImageCode.Gleitkommazahl, 16)) {
