...
namespace BlueBasics
{
    public static class ListOfExtension
    {
        ...
        public static bool AddIfNotExists<T>(this List<T> L, BindingList<T> Values) where T : IComparable
        {
        ...
        public static bool AddIfNotExists<T>(this List<T> L, List<T> Values) where T : IComparable
        {
            if (Values == null || Values.Count == 0) { return false; }
        ...
        public static bool AddIfNotExists<T>(this List<T> L, T Value) where T : IComparable
        {
