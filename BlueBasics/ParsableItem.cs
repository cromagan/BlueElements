...
public abstract class ParsableItem : IHasKeyName, IParseable {
    ...
    public ParsableItem(string keyname) {
    ...
    public static T? NewByParsing<T>(string code) where T : ParsableItem {
