...
internal sealed class Method_ConnectPointsWithSameName : Method, IMethod {

    #region Properties

    public static List<List<string>> Args => [[VariablePadItem.ShortName_Variable]];
    public static string Command => "connectpointswithsamename";
    public static List<string> Constants => [];
    public static string Description => "Verschiebt das vorhandene PadItem indem es versucht, gleiche Punktnamen herauszufinden.\r\nWird keinen Fehler auslösen.";
    ...
    public static string Syntax => "ConnectPointsWithSameName(PadItem);";
