...
public class Method_GenerateLayoutImage : Method_Database {
    ...
    public override List<string> Comand(List<Variable> currentvariables) => new() { "generatelayoutimage" };
    ...
    public override DoItFeedback DoIt(Script s, CanDoFeedback infos) {
        ...
        var ca = ((VariableString)attvar.Attributes[0]).ValueString;
        ...
        var sc = ((VariableFloat)attvar.Attributes[1]).ValueNum;
