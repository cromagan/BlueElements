...
public static class Skin {
    ...
    public static void LoadSkin() {
        ...
        Design.Add(Enums.Design.Button_ComboBox, States.Standard_MouseOver, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "B6B6B6", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Button_Slider_Waagerecht, States.Standard, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CDCDCD", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_Slider_Waagerecht, States.Standard_MouseOver_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CECECE", string.Empty, RahmenArt.Solide_3px, "B7B7B7", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Button_Slider_Waagerecht, States.Standard_MouseOver, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CECECE", string.Empty, RahmenArt.Solide_3px, "B7B7B7", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_Slider_Senkrecht, States.Standard, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CDCDCD", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_Slider_Senkrecht, States.Standard_MouseOver_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CECECE", string.Empty, RahmenArt.Solide_3px, "B7B7B7", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Table_And_Pad, States.Standard_MouseOver_HasFocus_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Table_And_Pad, States.Standard_Disabled, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Table_And_Pad, States.Standard_HasFocus, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.EasyPic, States.Standard, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.EasyPic, States.Standard_HasFocus_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.EasyPic, States.Standard_MouseOver_HasFocus_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Slider_Hintergrund_Waagerecht, States.Standard_MouseOver, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Ohne, "B7B7B7", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Slider_Hintergrund_Waagerecht, States.Standard_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Ohne, "B7B7B7", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Slider_Hintergrund_Senkrecht, States.Standard_MouseOver_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Ohne, "B7B7B7", string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Slider_Hintergrund_Senkrecht, States.Standard_MouseOver_HasFocus_MousePressed, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Ohne, "B7B7B7", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.RibbonBar_Body, States.Standard_Disabled, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "F4F5F6", string.Empty, RahmenArt.Solide_1px, "E5E4E5", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Progressbar, States.Standard, Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Table_Lines_thick, States.Standard, Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, "ACACAC", string.Empty, string.Empty, string.Empty);
