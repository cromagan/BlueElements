...
public static class Skin {
    ...
    public static void LoadSkin() {
        ...
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.TabStrip_Head, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.TextBox, States.Checked, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.TextBox, States.Checked_HasFocus, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_HasFocus, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_MouseOver_HasFocus, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_HasFocus_MousePressed, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_HasFocus, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_MouseOver_HasFocus, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_HasFocus_MousePressed, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_DropdownMenu, States.Checked, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "5D5D5D", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Checked_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_DropdownMenu, States.Standard_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_KontextMenu, States.Standard_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_KontextMenu_Caption, States.Standard_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_MouseOver_HasFocus_MousePressed, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Checked, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "5D5D5D", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Checked_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_MouseOver, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_MouseOver_HasFocus, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_Listbox, States.Checked, "Windows 11|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CCE8FF", string.Empty, RahmenArt.Solide_1px, "99D1FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Checked_Disabled, "Windows 11|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Item_Listbox_Caption, States.Standard_Disabled, "Windows 11 Checked|7", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.GroupBoxBold, States.Standard, "Windows 11|7", Enums.Kontur.Rechteck, 9, -11, 9, 9, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_21px, "40568D", string.Empty, string.Empty);
        Design.Add(Enums.Design.GroupBoxBold, States.Standard_Disabled, "Windows 11 Disabled|0", Enums.Kontur.Rechteck, 9, -11, 9, 9, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_21px, "ACACAC", string.Empty, string.Empty);
