...
public static class Skin {
    ...
    public static void LoadSkin() {
        ...
        Design.Add(Enums.Design.Button, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button, States.Standard_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button, States.Standard_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_3px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_CheckBox, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_3px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EFEFEF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_3px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_3px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "EAEAEA", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Button_OptionButton, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.TabStrip_Head, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, -2, 0, 5, HintergrundArt.Verlauf_Vertical_2, "F0F0F0", "E4E4E4", RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.TabStrip_Head, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.TabStrip_Head, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        Design.Add(Enums.Design.TabStrip_Head, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.TabStrip_Head, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, -2, 0, 5, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.TabStrip_Head, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, -2, 0, 5, HintergrundArt.Verlauf_Vertical_2, "F0F0F0", "E4E4E4", RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.RibbonBar_Head, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.RibbonBar_Head, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "F4F5F6", string.Empty, RahmenArt.Solide_1px, "E5E4E5", string.Empty, string.Empty);
        Design.Add(Enums.Design.RibbonBar_Head, States.Checked_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "F4F5F6", string.Empty, RahmenArt.Solide_1px, "E5E4E5", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.RibbonBar_Head, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 5, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Caption, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Caption, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "CheckBox");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "CheckBox_Checked");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "CheckBox_Disabled_Checked");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "CheckBox_Checked_MouseOver");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "CheckBox_Disabled");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "CheckBox_Checked");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "CheckBox_Checked_MouseOver");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "CheckBox_Checked");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "CheckBox_MouseOver");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "CheckBox_Checked_MouseOver");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "CheckBox");
        Design.Add(Enums.Design.CheckBox_TextStyle, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "CheckBox_MouseOver");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "OptionBox");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "OptionBox_Checked");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "OptionBox_Disabled_Checked");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "OptionBox_Checked_MouseOver");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "OptionBox_Disabled");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "OptionBox_Checked");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "OptionBox_Checked_MouseOver");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "OptionBox");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "OptionBox_MouseOver");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "OptionBox_Checked_MouseOver");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "OptionBox");
        Design.Add(Enums.Design.OptionButton_TextStyle, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.FocusDotLine, string.Empty, "000000", "OptionBox_MouseOver");
        Design.Add(Enums.Design.TextBox, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.TextBox, States.Checked, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.TextBox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.TextBox, States.Checked_HasFocus, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.TextBox, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_HasFocus, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_MouseOver_HasFocus, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_HasFocus_MousePressed, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "B6B6B6", string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.ComboBox_Textbox, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_CheckBox, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "81B8EF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Button_OptionButton, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard_MouseOver_HasFocus_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_HasFocus, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_MouseOver_HasFocus, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_HasFocus_MousePressed, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard_MouseOver, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "D8D8D8", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Checked_MouseOver_HasFocus_MousePressed, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbon_ComboBox_Textbox, States.Standard_MouseOver_HasFocus, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "3399FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Caption, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Ribbonbar_Caption, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.RibbonBar_Frame, States.Standard_Disabled, "Windows 11 Italic|0|1", Enums.Kontur.Rechteck, 1, 1, 0, 1, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "ACACAC", string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Form_MsgBox, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "F0F0F0", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Form_QuickInfo, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "4DA1B5", string.Empty, string.Empty);
        Design.Add(Enums.Design.Form_DesktopBenachrichtigung, States.Standard, "Windows 11|6|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "F0F0F0", string.Empty, RahmenArt.Solide_3px, "5D5D5D", string.Empty, string.Empty);
        Design.Add(Enums.Design.Form_BitteWarten, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "4DA1B5", string.Empty, string.Empty);
        Design.Add(Enums.Design.Form_AutoFilter, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Form_AutoFilter, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        ...
        Design.Add(Enums.Design.Form_SelectBox_Dropdown, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "FFFFFF", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Checked, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "5D5D5D", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Checked_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_DropdownMenu, States.Standard_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_KontextMenu, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_KontextMenu, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_KontextMenu, States.Standard_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_KontextMenu_Caption, States.Standard, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_KontextMenu_Caption, States.Standard_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_KontextMenu_Caption, States.Standard_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "4DA1B5", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_MouseOver_HasFocus_MousePressed, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Checked, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "5D5D5D", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Checked_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Solide_1px, "000000", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_HasFocus, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Autofilter, States.Standard_MouseOver_HasFocus, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "0072BC", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Standard, "Windows 11|0|0", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Standard_MouseOver_MousePressed, "Windows 11|0|2", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CCE8FF", string.Empty, RahmenArt.Solide_1px, "99D1FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Checked, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CCE8FF", string.Empty, RahmenArt.Solide_1px, "99D1FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Checked_Disabled, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Solide_1px, "B7B7B7", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Checked_MouseOver, "Windows 11|0|2", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CCE8FF", string.Empty, RahmenArt.Solide_1px, "99D1FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Checked_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CCE8FF", string.Empty, RahmenArt.Solide_1px, "99D1FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Standard_MouseOver, "Windows 11|0|2", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "E5F3FF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox, States.Standard_MousePressed, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "CCE8FF", string.Empty, RahmenArt.Solide_1px, "99D1FF", string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox_Caption, States.Standard, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox_Caption, States.Standard_Disabled, "Windows 11|7|16", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "DFDFDF", string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, string.Empty);
        Design.Add(Enums.Design.Item_Listbox_Caption, States.Standard_MouseOver, "Windows 11|7|0", Enums.Kontur.Rechteck, 0, 0, 0, 0, HintergrundArt.Solide, "BFDFFF", string.Empty, RahmenArt.Solide_1px, "4DA1B5", string.Empty, string.Empty);
        Design.Add(Enums.Design.GroupBox, States.Standard, "Windows 11|0|0", Enums.Kontur.Rechteck, 0, -7, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "ACACAC", string.Empty, string.Empty);
        Design.Add(Enums.Design.GroupBox, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 0, -7, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_1px, "ACACAC", string.Empty, string.Empty);
        Design.Add(Enums.Design.GroupBoxBold, States.Standard, "Windows 11|7|0", Enums.Kontur.Rechteck, 9, -11, 9, 9, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_21px, "40568D", string.Empty, string.Empty);
        Design.Add(Enums.Design.GroupBoxBold, States.Standard_Disabled, "Windows 11|0|1", Enums.Kontur.Rechteck, 9, -11, 9, 9, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Solide_21px, "ACACAC", string.Empty, string.Empty);
