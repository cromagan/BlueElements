    ...
    public sealed class TabControl : System.Windows.Forms.TabControl, IContextMenu, IBackgroundNone
    {
        ...
        private void DrawTabHead(Graphics graphics, int id)
        {
            ...
            if (_IsRibbonBar)
            {
                ...
                GenericControl.Skin.Draw_FormatedText(graphics, TabPages[id].Text, enDesign.RibbonBar_Head, tmpState, null, enAlignment.Horizontal_Vertical_Center, r, this, false);
            ...
            else
            {
                ...
                GenericControl.Skin.Draw_FormatedText(graphics, TabPages[id].Text, enDesign.TabStrip_Head, tmpState, null, enAlignment.Horizontal_Vertical_Center, r, this, false);
        ...
        public void ContextMenu_Show(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (UserMenu.Count > 0)
            {
                ...
                var _ContextMenu = FloatingInputBoxListBoxStyle.Show(UserMenu, _HotTab, this);
