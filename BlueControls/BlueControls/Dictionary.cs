...
namespace BlueControls
{
    internal static class Dictionary
    {
        ...
        {
            _DictWords = Database.LoadResource(Assembly.GetAssembly(typeof(clsSkin)), "Deutsch.MDB", "Dictionary", true, false, Table.Database_NeedPassword, CreativePad.GenerateLayoutFromRow, CreativePad.RenameColumnInLayout);
        }
