...
public class SQL_CellLikeListItem : BasicListItem {
    ...
    /// </summary>
    private readonly SQL_ColumnItem? _styleLikeThis;

    #endregion

    #region Constructors

    public SQL_CellLikeListItem(string internalAndReadableText, SQL_ColumnItem? columnStyle, ShortenStyle style, bool enabled, BildTextVerhalten bildTextverhalten) : base(internalAndReadableText, enabled) {
    ...
    public override object Clone() {
        var x = new SQL_CellLikeListItem(Internal, _styleLikeThis, _style, Enabled, _bildTextverhalten);
    ...
    public override bool FilterMatch(string filterText) {
        ...
        var txt = SQL_CellItem.ValueReadable(_styleLikeThis, Internal, ShortenStyle.Both, _styleLikeThis.BildTextVerhalten, true);
    ...
    protected override Size ComputeSizeUntouchedForListBox() => SQL_Table.FormatedText_NeededSize(_styleLikeThis, Internal, Skin.GetBlueFont(Parent.ItemDesign, States.Standard), _style, 16, _bildTextverhalten);
    ...
    protected override void DrawExplicit(Graphics gr, Rectangle positionModified, Design itemdesign, States vState, bool drawBorderAndBack, bool translate) {
        ...
        SQL_Table.Draw_FormatedText(gr, Internal, _styleLikeThis, positionModified, itemdesign, vState, _style, _bildTextverhalten);
        if (drawBorderAndBack) {
    ...
    protected override string GetCompareKey() {
        ...
        var txt = SQL_CellItem.ValueReadable(_styleLikeThis, Internal, ShortenStyle.HTML, _bildTextverhalten, true);
