...
public class RowOutputPadItem : CustomizableShowPadItem, IItemToControl {

    #region Constructors

    public RowOutputPadItem(string internalname) : base(internalname) {
    ...
    protected override string ClassId() => "FI-OutputRow";
    ...
    protected override BasicPadItem? TryCreate(string id, string name) {
        ...
        //    return new RowOutputPadItem(name);
        //}
        return null;
    }
