...
public class ItemCollectionList : List<AbstractListItem> {

    #region Constructors

    public ItemCollectionList(List<IReadableTextWithKey> items) {
    ...
    public ItemCollectionList(bool dummy) { }

    public ItemCollectionList(List<AbstractListItem> abstractListItems) {
        AddRange(abstractListItems);
    }
