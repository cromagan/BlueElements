...
public static class Skin {
    ...
    public static void LoadSkin() {
        ...
        Design.Add(Enums.Design.Table_Cell_New, States.Standard, Enums.Kontur.Ohne, 0, 0, 0, 0, HintergrundArt.Ohne, string.Empty, string.Empty, RahmenArt.Ohne, string.Empty, string.Empty, "{Name=Calibri, Size=10[K]15,Italic=True}", string.Empty);
