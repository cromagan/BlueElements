...
public static class Skin {
    ...
    public static void InitStyles() => StyleDb = DatabaseAbstract.LoadResource(Assembly.GetAssembly(typeof(Skin)), "Styles.BDB", "Styles", true, false, DatabaseAbstract.Administrator);
