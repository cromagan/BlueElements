...
namespace BlueControls
{
    public sealed class clsSkin
    {
        ...
        internal BlueFont GetBlueFont(int _Design, enStates vState, RowItem RowOfStyle, int Stufe)
        {
            ...
            if (_Design > 10000)
            {
                return GenericControl.Skin.GetBlueFont((PadStyles)_Design, vState, RowOfStyle, Stufe);
            }

            return GenericControl.Skin.GetBlueFont((enDesign)_Design, vState, RowOfStyle, Stufe);
        ...
        internal BlueFont GetBlueFont(PadStyles vDesign, enStates vState, RowItem RowOfStyle, int Stufe)
        {
            switch (Stufe)
            {
                case 4:
        ...
        internal BlueFont GetBlueFont(enDesign vDesign, enStates vState, RowItem RowOfStyle, int Stufe)
        {
