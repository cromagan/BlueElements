...
public class CellLinkStartChar : Char, IParseable {

    #region Constructors

    public CellLinkStartChar() { }

    internal CellLinkStartChar(ExtText parent, List<string> overrideTags, string tableName, string columnKey, string rowKey) : base(parent, overrideTags) {
        TableName = tableName;
        ColumnKey = columnKey;
        RowKey = rowKey;
    ...
    internal CellLinkStartChar(ExtText parent, int styleFromPos, string tableName, string columnKey, string rowKey) : base(parent, styleFromPos) {
        TableName = tableName;
        ColumnKey = columnKey;
        RowKey = rowKey;
        ResolveAndStoreDisplayText();
    ...
    public override string HtmlText() => LinkifyScriptCommand.GenerateHtmlCellLink(TableName, ColumnKey, RowKey, DisplayText, false);
