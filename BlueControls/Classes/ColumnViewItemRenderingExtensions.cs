...
public static class ColumnViewItemRenderingExtensions {
    ...
    /// <summary>
    /// Hält zusätzliche Render-Daten pro ColumnViewCollection vor. Da es sich um eine
    /// ConditionalWeakTable{TKey, TValue} handelt, werden die Einträge automatisch
    ...
    /// <summary>
    /// Hält zusätzliche Render-Daten pro ColumnViewItem vor (z. B. Position, Breite,
    /// gecachter Renderer). Da es sich um eine ConditionalWeakTable{TKey, TValue}
