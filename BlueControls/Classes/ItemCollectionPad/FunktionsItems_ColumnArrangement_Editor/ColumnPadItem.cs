...
public class ColumnPadItem : FixedRectangleBitmapPadItem, IHasTable {
    ...
    protected override void GeneratePic() {
        ...
        if (r is { IsDisposed: false }) {
            Renderer?.Draw(gr, r.CellGetString(col), null, new Rectangle(0, 210, bmp.Width, 90), col.DoOpticalTranslation, (Alignment)col.Align, 1f, Design.Item_ListBox, States.Standard);
        }
