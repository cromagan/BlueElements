...
public sealed partial class FileExplorer : GenericControlReciver   //UserControl //
{
    #region Fields
    ...
    public FileExplorer() : base(false, false, false) {
        InitializeComponent();
    ...
    private void Contextmenu_Rename(object? sender, ContextMenuEventArgs e) {
        ...
        var nn = InputBox.Show("Neuer Name:", n.FileNameWithoutSuffix(), Formats.TextFormat.Instance);
    ...
    private DragDropEffects CurrentState(DragEventArgs e) {
        ...
        if (opr.IsFailed) { return DragDropEffects.None; }
    ...
    private void lsbFiles_ItemClicked(object sender, ListItemEventArgs e) {
        OnItemClicked(e);
    ...
    private void ThumbGenerator_DoWork(object sender, DoWorkEventArgs e) {
        ...
        foreach (var fileName in allF) {
            ...
            switch (Sort) {
                ...
                default:
                    bli.UserDefCompareKey = SecondSortChar + bli.Caption.ToUpperInvariant();
                    break;
            }
        ...
        foreach (var thisString in allD) {
            if (AddThisFolder(thisString)) {
                ...
                bli.Padding = 10;
                bli.UserDefCompareKey = FirstSortChar + thisString.ToUpperInvariant();
                feedBack = ["Add", bli];
                ThumbGenerator.ReportProgress(1, feedBack);
            }
        }
