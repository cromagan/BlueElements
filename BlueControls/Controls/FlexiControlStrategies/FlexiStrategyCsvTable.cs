...
/// <see cref="FlexiStrategyBase.StrategyParameter" /> enthält die Spaltennamen,
/// getrennt mit ";" (z. B. "Spalte1;Spalte2;Spalte3"). Der Value ist CSV-serialisiert:
/// Spalten getrennt mit ";", Zeilen getrennt mit CR.
/// Bei <see cref="FlexiStrategyBase.AutoSort" /> == false werden Zeilennummern
/// über die Systemspalte SYS_ROWSORTINDEX eingeblendet.
/// </summary>
public class FlexiStrategyCsvTable : FlexiStrategyBase {
    ...
    private void BuildTable() {
        ...
        _table.TableAdmin = new[] { Constants.Everybody }.AsReadOnly();
        _table.PermissionGroupsNewRow = new[] { Constants.Everybody }.AsReadOnly();
