...
public sealed class FilledRectangleDrawingHelper : DrawingHelper {
    ...
    public static FilledRectangleDrawingHelper Instance => (FilledRectangleDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
