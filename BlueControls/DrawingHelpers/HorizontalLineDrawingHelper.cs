...
public sealed class HorizontalLineDrawingHelper : DrawingHelper {
    ...
    public static HorizontalLineDrawingHelper Instance => (HorizontalLineDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
