...
public sealed class MagnifierDrawingHelper : DrawingHelper {
    ...
    public static MagnifierDrawingHelper Instance => (MagnifierDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
