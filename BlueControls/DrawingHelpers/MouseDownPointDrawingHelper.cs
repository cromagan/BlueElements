...
public sealed class MouseDownPointDrawingHelper : DrawingHelper {
    ...
    public static MouseDownPointDrawingHelper Instance => (MouseDownPointDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
