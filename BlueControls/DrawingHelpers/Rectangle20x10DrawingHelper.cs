...
public sealed class Rectangle20x10DrawingHelper : DrawingHelper {
    ...
    public static Rectangle20x10DrawingHelper Instance => (Rectangle20x10DrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
