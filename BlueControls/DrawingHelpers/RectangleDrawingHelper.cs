...
public sealed class RectangleDrawingHelper : DrawingHelper {
    ...
    public static RectangleDrawingHelper Instance => (RectangleDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
