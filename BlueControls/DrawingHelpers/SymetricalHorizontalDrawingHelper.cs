...
public sealed class SymetricalHorizontalDrawingHelper : DrawingHelper {
    ...
    public static SymetricalHorizontalDrawingHelper Instance => (SymetricalHorizontalDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
