...
public sealed class VerticalLineDrawingHelper : DrawingHelper {
    ...
    public static VerticalLineDrawingHelper Instance => (VerticalLineDrawingHelper)(AllHelpers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
