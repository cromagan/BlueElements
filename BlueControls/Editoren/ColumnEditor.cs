...
internal sealed partial class ColumnEditor : IIsEditor, IHasTable {
    ...
    private void btnVerwendung_Click(object sender, System.EventArgs e) => Forms.MessageBox.Show(TableView.ColumnUsage(Column));
    ...
    private void Column_DatenAuslesen() {
        ...
        if (!Column.IsSystemColumn()) {
            ...
            capInfo.Text = "<Imagecode=" + Column.SymbolForReadableText() + "> Normale Spalte";
        } else {
            btnStandard.Enabled = true;
            capInfo.Text = "<Imagecode=" + Column.SymbolForReadableText() + "> System Spalte";
        }
