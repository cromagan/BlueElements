...
public partial class InputBox : DialogWithOkAndCancel {
    ...
    private InputBox() : this(string.Empty, string.Empty, BlueBasics.Classes.Formats.TextFormat.Instance, false) { }
    ...
    public static string Show(string txt) => Show(txt, string.Empty, BlueBasics.Classes.Formats.TextFormat.Instance, false);
    ...
    /// <param name="textformat">Beispiel: BlueBasics.Format oder BlueTable.BlueBasics.Classes.Formats.TextFormat.Instance</param>
    /// <returns></returns>
