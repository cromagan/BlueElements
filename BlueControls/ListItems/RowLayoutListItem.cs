...
public class RowLayoutListItem : ListItem {
    ...
    /// Als Interner Name wird der RowKey als String abgelegt
    /// </summary>
    public RowLayoutListItem(RowItem row, string layoutId) : this(row, layoutId, string.Empty) { }
    ...
    private void GeneratePic() {
        ...
        var pad = new CollectionPadItem(_layoutFileName);
        pad.ResetVariables();
        ...
        var zoomv = CollectionPadItem.ZoomFitValue(canvasUsedArea, _tmpBmp.Size);
