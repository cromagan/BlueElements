...
public sealed class JigglyRedLineMarkRenderer : MarkRenderer {
    ...
    public static JigglyRedLineMarkRenderer Instance => (JigglyRedLineMarkRenderer)(AllRenderers[Type] ?? throw Develop.DebugError("Fehlerhafter Instanzname"));
