...
public abstract class SizeableRectanglePadItem : PadItem {
    ...
    protected SizeableRectanglePadItem(string keyName) : base(keyName) {
        BeginInit();
    ...
    public virtual float Breite {
        ...
        set {
            ...
            Pru.X = Plo.X + MmToPixel(value, CollectionPadItem.Dpi);
            OnPropertyChanged();
        }
    }
    ...
    public virtual float Höhe {
        ...
        set {
            ...
            Pru.Y = Plo.Y + MmToPixel(value, CollectionPadItem.Dpi);
            OnPropertyChanged();
        }
    }
    ...
    public override List<GenericControl> GetProperties(int widthOfControl) {
        ...
        [   .. base.GetProperties(widthOfControl),
            ...
            new FlexiControlForProperty<int>(() => Drehwinkel) { Suffix = "°" },
