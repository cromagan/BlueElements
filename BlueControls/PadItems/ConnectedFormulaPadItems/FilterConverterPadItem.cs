...
public class FilterConverterPadItem : ReciverSenderPadItem, IItemToControl, IAutosizable {
    ...
    public FilterConverterPadItem() : this(string.Empty, null, null) { }

    public FilterConverterPadItem(string keyName, ConnectedFormula? cformula) : this(keyName, null, cformula) { }

    public FilterConverterPadItem(string keyName, Table? db, ConnectedFormula? cformula) : base(keyName, cformula, db) { }
    ...
    public override List<GenericControl> GetProperties(int widthOfControl) {
        ...
        if (TableOutput is { IsDisposed: false } tb) {
            ...
            if (filterWertFlex.Strategy is TextBoxSuggestionsControlStrategy tbs) {
