...
public class RegionFormulaPadItem : ReciverPadItem, IItemToControl, IAutosizable {
    ...
    public RegionFormulaPadItem(string keyName, ConnectedFormula? cformula) : base(keyName, cformula) => ParentFormula?.PropertyChanged += ParentFormula_PropertyChanged;
