...
public class TableViewPadItem : ReciverSenderPadItem, IItemToControl, IAutosizable {
    ...
    public static List<ListItem> AllAvailableColumArrangemengts(Table db) {
    ...
    public static List<ListItem> AllAvailableRowScripts(Table db) {
        var u = new List<ListItem>();
    ...
    public Control CreateControl(ConnectedFormulaView parent, string mode) {
        ...
        con.EditButton = string.Equals(UserGroup, Administrator, StringComparison.OrdinalIgnoreCase);
