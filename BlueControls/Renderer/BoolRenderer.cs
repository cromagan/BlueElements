...
public class BoolRenderer : Renderer {
    ...
    public static List<ListItem> SymboleFalse() => [
    ...
    public static List<ListItem> SymboleNeutral() => [
    ...
    public static List<ListItem> SymboleTrue() => [
    ...
    public static List<ListItem> TexteFalse() => [
        ItemOf("Nein"),
        ItemOf("Falsch"),
        ItemOf("Nein danke"),
        ItemOf("Nicht"),
    ...
    public static List<ListItem> TexteNeutral() => [
        ItemOf("—"),
        ItemOf("o"),
        ItemOf("Unbekannt"),
        ItemOf("Vielleicht")
    ...
    public static List<ListItem> TexteTrue() => [
        ItemOf("Ja"),
        ItemOf("Wahr"),
        ItemOf("Richtig"),
        ItemOf("OK")
