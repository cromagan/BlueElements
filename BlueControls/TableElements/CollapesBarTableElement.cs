...
public sealed class CollapesBarTableElement : TableElement {
    ...
    public const string Identifier = "CollapesBarTableElement";
    ...
    public CollapesBarTableElement(ColumnViewCollection? arrangement) : base(Identifier, arrangement, string.Empty) => IgnoreYOffset = true;
