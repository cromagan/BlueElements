...
public sealed class EditBarTableElement : TableElement {

    #region Fields

    public const int ButtonCount = 2;
    public const int ButtonSize = 16;
    public const string Identifier = "EditBarTableElement";

    #endregion

    #region Constructors

    public EditBarTableElement(ColumnViewCollection? arrangement) : base(Identifier, arrangement, string.Empty) => IgnoreYOffset = true;
