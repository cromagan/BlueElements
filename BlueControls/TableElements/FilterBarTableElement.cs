...
public sealed class FilterBarTableElement : TableElement {
    ...
    public const string Identifier = "FilterBarTableElement";
    ...
    public FilterBarTableElement(ColumnViewCollection? arrangement) : base(Identifier, arrangement, string.Empty) => IgnoreYOffset = true;
