...
public sealed class TableEndTableElement : TableElement {

    #region Fields

    public const string Identifier = "TableEndTableElement";

    #endregion

    #region Constructors

    public TableEndTableElement(ColumnViewCollection? arrangement) : base(Identifier, arrangement, string.Empty) { }
