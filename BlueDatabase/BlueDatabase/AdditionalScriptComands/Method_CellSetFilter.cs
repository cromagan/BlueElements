...
namespace BlueScript {
    ...
    public class Method_CellSetFilter : MethodDatabase {
        ...
        public override string Description => "Lädt eine andere Datenbank sucht eine Zeile mit einem Filter und und setzten den Wert. Ein Filter kann mit dem Befehl 'Filter' erstellt werden. Gibt WAHr zurück, wenn der Wert erfolgreich gesetzt wurde.";
        ...
        public override strDoItFeedback DoIt(strCanDoFeedback infos, Script s) {
            ...
            var allFi = Method_Filter.Filter(attvar.Attributes, 2);
