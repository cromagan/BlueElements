...
namespace BlueDatabase.EventArgs
{
    public class DatabaseSettingsEventHandler : System.EventArgs
    {
        ...
        public DatabaseSettingsEventHandler(ColumnItem ExecutingColumn, string Filenname, bool ReadOnly, GetPassword PasswordSub, GenerateLayout_Internal GenLayout, RenameColumnInLayout RenameColumn)
        {
