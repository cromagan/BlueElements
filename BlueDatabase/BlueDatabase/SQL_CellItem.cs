...
public class SQL_CellItem {
    ...
    public SQL_CellItem(string value, int width, int height) {
        _value = value;
    ...
    public static Tuple<string, QuickImage> GetDrawingData(SQL_ColumnItem? column, string originalText, ShortenStyle style, BildTextVerhalten bildTextverhalten) {
    ...
    //public static enAlignment StandardAlignment(SQL_ColumnItem column, BildTextVerhalten bildTextverhalten) {
    //    switch (column.Align) {
    ...
    public static QuickImage? StandardErrorImage(string gr, BildTextVerhalten bildTextverhalten, string originalText, SQL_ColumnItem? column) {
    ...
    /// <returns></returns>
    public static string ValueReadable(SQL_ColumnItem? column, string txt, ShortenStyle style, BildTextVerhalten bildTextverhalten, bool removeLineBreaks) {
    ...
    /// </summary>
    /// <returns></returns>
    public static List<string> ValuesReadable(SQL_ColumnItem? column, SQL_RowItem Row, ShortenStyle Style) {
    ...
    private static QuickImage? StandardImage(SQL_ColumnItem? column, string originalText, string replacedText, ShortenStyle style, BildTextVerhalten bildTextverhalten) {
