...
public sealed class SQL_ColumnViewItem {

    #region Fields

    public readonly SQL_ColumnViewCollection Parent;
    ...
    public SQL_ColumnViewItem(SQL_ColumnItem column, ViewType type, SQL_ColumnViewCollection parent) : this(parent) {
        Column = column;
        _viewType = type;
    }

    public SQL_ColumnViewItem(SQL_Database database, string codeToParse, SQL_ColumnViewCollection parent) : this(parent) {
    ...
    private SQL_ColumnViewItem(SQL_ColumnViewCollection parent) : base() {
        Parent = parent;
    ...
    public SQL_ColumnViewItem? NextVisible() => Parent.NextVisible(this);

    public void OnChanged() => Changed?.Invoke(this, System.EventArgs.Empty);

    public SQL_ColumnViewItem? PreviewsVisible() => Parent.PreviousVisible(this);
