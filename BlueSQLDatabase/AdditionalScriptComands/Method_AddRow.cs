...
namespace BlueSQLDatabase.AdditionalScriptComands {
    ...
    public class Method_SQLAddRow : MethodSQLDatabase {
        ...
        public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
            ...
            //if (r != null && !((VariableBool)attvar.Attributes[2]).ValueBool) { return Method_SQLRow.RowToObject(r); }
            ...
            return Method_SQLRow.RowToObjectFeedback(r);
        }
