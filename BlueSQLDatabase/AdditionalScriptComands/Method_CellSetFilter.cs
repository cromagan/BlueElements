...
namespace BlueSQLDatabase.AdditionalScriptComands {
    ...
    public class Method_SQLCellSetFilter : MethodSQLDatabase {

        #region Properties

        public override List<List<string>> Args => new() { new() { VariableString.ShortName_Plain }, new() { VariableString.ShortName_Plain }, new() { VariableSQLFilterItem.ShortName_Variable } };
        ...
        public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
            ...
            var allFi = Method_SQLFilter.ObjectToFilter(attvar.Attributes, 2);
