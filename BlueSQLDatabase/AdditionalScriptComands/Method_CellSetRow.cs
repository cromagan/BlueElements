...
namespace BlueSQLDatabase.AdditionalScriptComands {
    ...
    public class Method_SQLCellSetRow : MethodSQLDatabase {

        #region Properties

        public override List<List<string>> Args => new() { new() { VariableString.ShortName_Plain }, new() { VariableString.ShortName_Plain }, new() { VariableSQLRowItem.ShortName_Variable } };
        ...
        public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
            ...
            var row = Method_SQLRow.ObjectToRow(attvar.Attributes[2]);
