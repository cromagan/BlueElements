...
namespace BlueSQLDatabase.AdditionalScriptComands {
    ...
    public class Method_SQLFilter : MethodSQLDatabase {
        ...
        public override string Returns => VariableSQLFilterItem.ShortName_Variable;
        ...
        public static List<FilterItem>? ObjectToFilter(List<Variable>? attributes, int ab) {
            ...
            for (var z = ab; z < attributes.Count; z++) {
                if (attributes[z] is not VariableSQLFilterItem fi) { return null; } // new DoItFeedback("Kein Filter übergeben.");
        ...
        public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
            ...
            return new DoItFeedback(new VariableSQLFilterItem(fii));
        }
