...
namespace BlueSQLDatabase.AdditionalScriptComands {
    ...
    public class Method_SQLLookup : MethodSQLDatabase {
        ...
        public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
            ...
            //return v[0].Type != VariableSQLDataType.List
            //    ? new DoItFeedback(v[0].ValueString + "\r", VariableSQLDataType.List)
            //    : new DoItFeedback(v[0].ValueString, VariableSQLDataType.List);
        }
