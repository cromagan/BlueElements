...
namespace BlueSQLDatabase.AdditionalScriptComands {
    ...
    public class Method_SQLSetError : MethodSQLDatabase {
        ...
        public override string Description => "Bei Zeilenprüfungen wird ein Fehler abgesetzt. Dessen Inhalt bestimmt die Nachricht. Die Spalten, die als fehlerhaft markiert werden sollen, müssen nachträglich als VariableSQLnnamen angegeben werden.";
        ...
        public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
            ...
            for (var z = 1; z < attvar.Attributes.Count; z++) {
                ...
                //var ve = s.VariableSQLn.GetSystem(n);
                //if (ve == null) {
                //    ve = new VariableSQL(n, string.Empty, enVariableSQLDataType.List, false, true, string.Empty);
                //    s.VariableSQLn.Add(ve);
                //}
                //ve.Readonly = false;
