    ...
    public sealed class Database : BlueBasics.MultiUserFile.MultiUserFile {
        ...
        protected override byte[] ToListOfByte() {
            try {
                ...
                SaveToByteList(l, DatabaseDataType.Formatkennung, "BlueSQLDatabase");
                SaveToByteList(l, DatabaseDataType.Version, DatabaseVersion);
                SaveToByteList(l, DatabaseDataType.Werbung, "                                                                    BlueSQLDatabase - (c) by Christian Peter                                                                                        "); // Die Werbung dient als Dummy-Platzhalter, falls doch mal was vergessen wurde...
