...
internal class Method_BitmapToBase64 : Method {
    ...
    public override List<List<string>> Args => new() { new List<string> { VariableBitmap.ShortName_Variable }, new List<string> { VariableString.ShortName_Plain } };
    ...
    public override DoItFeedback DoIt(CanDoFeedback infos, Script s) {
        ...
        switch (((VariableString)attvar.Attributes[1]).ValueString.ToUpper()) {
            ...
            default:
                return new DoItFeedback(infos, s, "Es wir als zweites Attribut ein String mit dem Inhalt jpg oder png erwartet.");
        }

        return new DoItFeedback(infos, s, x, string.Empty);
    }
