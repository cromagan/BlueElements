...
internal class Method_Filesuffix : Method {
    ...
    public override DoItFeedback DoIt(VariableCollection varCol, SplittedAttributesFeedback attvar, ScriptProperties scp, CanDoFeedback ld)=> new(attvar.ValueStringGet(0).FileSuffix(), ld.EndPosition());
