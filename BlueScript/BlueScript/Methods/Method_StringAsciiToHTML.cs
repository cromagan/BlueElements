...
internal class Method_StringAsciiToHTML : Method {
    ...
    public override DoItFeedback DoIt(VariableCollection varCol, SplittedAttributesFeedback attvar, ScriptProperties scp, LogData ld) => new DoItFeedback(attvar.ValueStringGet(0).CreateHtmlCodes(!attvar.ValueBoolGet(1)));
