...
internal class Method_ToUpper : Method {
    ...
    public override List<string>Comand(List<Variable>? currentvariables) => new() { "toupper" };
    ...
    public override DoItFeedback DoIt(Script s, CanDoFeedback infos) {
        ...
        return new DoItFeedback(infos, ((VariableString)attvar.Attributes[0]).ValueString.ToUpper(), string.Empty);
    }
