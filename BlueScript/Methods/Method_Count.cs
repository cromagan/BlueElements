...
internal sealed class Method_Count : Method {
    ...
    public static DoItFeedback DoItSplitted(VariableCollection varCol, SplittedAttributesFeedback attvar, ScriptProperties scp, LogData ld) => new(attvar.ValueListStringGet(0).Count);
