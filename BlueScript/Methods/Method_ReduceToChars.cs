...
internal sealed class Method_ReduceToChars : Method {
    ...
    public static DoItFeedback DoItSplitted(VariableCollection varCol, SplittedAttributesFeedback attvar, ScriptProperties scp, LogData ld) => new(attvar.ValueStringGet(0).ReduceToChars(attvar.ValueStringGet(1)));
