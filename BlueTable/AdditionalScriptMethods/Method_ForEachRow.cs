...
internal sealed class Method_ForEachRow : Method_TableGeneric {

    #region Properties

    public static List<List<string>> Args => [[VariableUnknown.ShortName_Plain], FilterVar];
    public static string Command => "foreachrow";
    ...
    public static string Syntax => "ForEachRow(NeueVariable, Filter1, ...) { }";
