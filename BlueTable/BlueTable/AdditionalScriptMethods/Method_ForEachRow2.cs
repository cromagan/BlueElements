...
using static BlueScript.Variables.VariableListRow;
...
internal class Method_ForEachRow2 : Method_TableGeneric {
    ...
    public override DoItFeedback DoIt(VariableCollection varCol, CanDoFeedback infos, ScriptProperties scp) {
        if (MyTable(scp) is not { IsDisposed: false } myDb) { return DoItFeedback.InternerFehler(infos.LogData); }
        ...
        foreach (var thisl in r) {
            ...
            scx = Method_CallByFilename.CallSub(varCol, scp2, "ForEachRow2-Schleife", infos.CodeBlockAfterText, infos.LogData.Line - 1, infos.LogData.Subname, nv, null, "ForEachRow2", infos.LogData);
