...
public static class ColumnErrorConstants {
    ...
    public const string ChapterColumnMultilineWithRepeat = "Kapitel-Spalten dürfen bei wiederholten Kapiteln (Kapitel einzigartig anzeigen = aus) nicht mehrzeilig sein.";
    ...
    public const string EmptyNotAllowed = "Leere Zellen bei diesem Format nicht erlaubt.";
