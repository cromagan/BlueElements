...
public class DateColumnFormat : Classes.ColumnFormat {
    ...
    public static Classes.ColumnFormat Instance => AllFormats[Formats.DateFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
