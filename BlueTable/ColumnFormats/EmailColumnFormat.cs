...
public class EmailColumnFormat : Classes.ColumnFormat {
    ...
    public static Classes.ColumnFormat Instance => AllFormats[Formats.EMailFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
