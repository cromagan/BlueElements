...
public class FilepathColumnFormat : ColumnFormat {
    ...
    public static ColumnFormat Instance => AllFormats[Formats.FilepathFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
