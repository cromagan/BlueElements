...
public class FloatColumnFormat : ColumnFormat {
    ...
    public static ColumnFormat Instance => AllFormats[Formats.FloatFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
