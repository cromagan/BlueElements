...
public class LongColumnFormat : ColumnFormat {
    ...
    public static ColumnFormat Instance => AllFormats[Formats.LongFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
