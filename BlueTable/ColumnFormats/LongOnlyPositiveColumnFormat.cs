...
public class LongOnlyPositiveColumnFormat : Classes.ColumnFormat {
    ...
    public static Classes.ColumnFormat Instance => AllFormats[Formats.LongOnlyPositiveFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
