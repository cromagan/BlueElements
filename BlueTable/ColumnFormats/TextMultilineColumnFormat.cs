...
public class TextMultilineColumnFormat : ColumnFormat {
    ...
    public static ColumnFormat Instance => AllFormats[Formats.TextMultilineFormat.Keyname] ?? throw Develop.DebugError("Fehlerhafter Instanzname");
