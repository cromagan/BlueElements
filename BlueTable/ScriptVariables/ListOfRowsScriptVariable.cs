...
public class ListOfRowsScriptVariable : ScriptVariable {
    ...
    public ListOfRowsScriptVariable(string name, IReadOnlyCollection<RowItem>? value, bool ronly, string comment) : base(name, ronly, comment) {
        _list = [];
    ...
    public ListOfRowsScriptVariable() : this(string.Empty, null, true, string.Empty) { }

    public ListOfRowsScriptVariable(string name) : this(name, null, true, string.Empty) { }

    public ListOfRowsScriptVariable(IReadOnlyCollection<RowItem>? value) : this(DummyName(), value, true, string.Empty) { }

    public ListOfRowsScriptVariable(IEnumerable<RowItem> value) : this([.. value]) { }
    ...
    public override string GetValueFrom(ScriptVariable variable) {
        if (variable is not ListOfRowsScriptVariable v) { return VerschiedeneTypen(variable); }
